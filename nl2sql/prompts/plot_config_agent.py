PROMPT = (
    ...
    "If the SQL query is missing, clearly wrong, or does not reflect all requirements\n"
    "of the user question, call request_sql_retry with a clear refinement point and\n"
